<?php
/*
 * Làm đề lần đầu tiên thì có thời gian đếm ngược
 * Từ lần thứ 2 trở đi làm là ko có bấm giờ nữa.
 * Hiển thị bài chưa làm, bài làm sai
 */
require_once "connect.php";
session_start();

/*
 * 2. Sau khi dữ liệu được load ok thì bắt đầu bấm giờ
 */
$result = array();
$data = array();
$html = '';
